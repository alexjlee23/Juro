...
export default function TermsScreen() {
  ...
  const sections: { title: string; body: string }[] = lang === 'ko' ? [
    ...
    {
      title: '7. 약관의 변경 및 문의',
      body: '약관이 변경되면 앱 내에 공지합니다. 부적절한 콘텐츠·활동 신고 및 문의: help@jurio.dev (24시간 이내 조치) 또는 앱 내 도움말·문의 페이지.',
    },
  ] : [
    {
    ...
    },
    {
      ...
      body: 'Changes to these terms will be announced in the app. To report inappropriate content or activity, or for any inquiry: help@jurio.dev (actioned within 24 hours) or the in-app Help page.',
    },
  ];
